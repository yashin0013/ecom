...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::get('user/directory', 'DirectoryController@directory');
    Route::get('directory/form', 'DirectoryController@form');
    Route::post('insert_service_provider', 'DirectoryController@insert_service_provider');
    Route::post('directory/form_submit', 'DirectoryController@sp_details');
