...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::get('/city', 'DirectoryController@city');
        Route::post('/insert_city', 'DirectoryController@insert_city');
        Route::post('/insert_profession', 'DirectoryController@insert_profession');
        Route::get('/delete_city/{id}', 'DirectoryController@delete_city');
        Route::get('/delete_profession/{id}', 'DirectoryController@delete_profession');
        
        Route::get('/service_providers', 'DirectoryController@service_providers');
        Route::post('/sp_status/{i}', 'DirectoryController@sp_status');
        Route::get('/sp_delete/{id}', 'DirectoryController@sp_delete');
    });
