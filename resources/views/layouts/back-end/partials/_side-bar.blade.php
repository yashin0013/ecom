                ...
                <div class="navbar-vertical-content mt-2">
                    ...
                    <!--reporting and analysis ends here-->
                        ...
                        @endif
                            ...
                            <li class="nav-item {{(Request::is('admin/directory*') || Request::is('admin/city*') || Request::is('admin/service_providers*'))?'scroll-here':''}}">
                                <small class="nav-subtitle">Directory Section</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/service_providers*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{url('admin/service_providers')}}">
                                    <i class="tio-user nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
